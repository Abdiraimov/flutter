...
import 'package:lesson20_bmi_continue4/components/calculate_button.dart';
import 'package:lesson20_bmi_continue4/components/height.dart';
import 'package:lesson20_bmi_continue4/components/male_female.dart';
import 'package:lesson20_bmi_continue4/components/result_page.dart';
import 'package:lesson20_bmi_continue4/components/status_card.dart';
import 'package:lesson20_bmi_continue4/components/weight_age.dart';
  ...
  void results (){
    final res = weight / pow(height / 100,2 );
        if(res <= 18.5){
          ...
          _showAlertDialog(context, 'Сиз салмактуусуз');
        }
  }
  @override
